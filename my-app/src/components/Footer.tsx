    ...
    <footer className="relative overflow-hidden bg-[linear-gradient(180deg,#ffffff_0%,#f8fbff_30%,#eff6ff_68%,#ffffff_100%)] px-4 pb-10 pt-28 text-slate-900 sm:px-6 lg:px-8 lg:pb-12 lg:pt-32">
      ...
      <div className="relative mx-auto max-w-7xl">
        <div className="rounded-t-[3rem] border border-white/80 bg-[linear-gradient(180deg,rgba(255,255,255,0.9)_0%,rgba(248,250,252,0.84)_100%)] px-6 pb-8 pt-8 shadow-[0_26px_90px_rgba(148,163,184,0.14)] backdrop-blur-xl sm:px-8 md:px-10 md:pb-10 md:pt-10 lg:px-12 lg:pb-12 lg:pt-12">
          <div className="mx-auto mb-10 max-w-3xl rounded-[2rem] border border-white/90 bg-white/76 px-5 py-6 text-center shadow-[0_14px_36px_rgba(148,163,184,0.12)] backdrop-blur-xl sm:px-7 sm:py-7 md:mb-14 md:px-10 md:py-9">
            ...
            <div className="mx-auto mt-7 flex max-w-2xl flex-col items-center gap-3 sm:flex-row sm:justify-center">
              <a
          ...
          <div className="grid gap-12 rounded-[2.25rem] border border-white/90 bg-[linear-gradient(180deg,rgba(255,255,255,0.8)_0%,rgba(248,250,252,0.76)_100%)] p-8 shadow-[inset_0_1px_0_rgba(255,255,255,0.9)] backdrop-blur-md md:grid-cols-[1.2fr_0.8fr] md:p-10 lg:gap-16 lg:p-12">
            <div className="text-center md:text-left">
              ...
              <p className="mx-auto max-w-xl text-base leading-8 text-slate-600 md:mx-0 md:text-lg">
            ...
            <div className="grid gap-10 text-center sm:grid-cols-2 md:text-left md:justify-items-end">
              ...
              <div className="w-full max-w-[220px]">
                <div className="mb-4 text-sm font-semibold uppercase tracking-[0.22em] text-slate-500">Contact</div>
                <ul className="space-y-3 text-slate-700">
                  <li>
                    <a href="mailto:contact@codewithsage.com" className="transition hover:text-slate-900">
                      contact@codewithsage.com
                    </a>
                  </li>
                  <li>
                    <a href="https://wa.me/2348182006156" className="transition hover:text-slate-900">
                      +234 818 200 6156
                    </a>
                  </li>
                </ul>
