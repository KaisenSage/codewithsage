    ...
    >
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-4xl items-center justify-center pt-14 sm:pt-18 md:pt-20 lg:pt-28">
        <div className="flex w-full flex-col items-center">
          {/* Action Buttons */}
          <div className="mt-8 flex w-full max-w-xl flex-col gap-4 sm:mt-10 md:mt-12 md:max-w-none md:flex-row md:justify-center">
            <Link
              href="/get-started"
              className="flex items-center justify-center rounded-full bg-gradient-to-r from-blue-600 to-pink-500 px-7 py-3.5 text-base font-semibold text-white shadow transition duration-200 hover:scale-105 sm:px-8 md:px-9 md:py-4 md:text-lg"
            >
            ...
            <Link
              href="/portfolio"
              className="flex items-center justify-center rounded-full border border-gray-300 bg-white px-7 py-3.5 text-base font-semibold text-gray-900 shadow transition duration-200 hover:scale-105 sm:px-8 md:px-9 md:py-4 md:text-lg"
            >
