import { FiBriefcase, FiUser, FiGlobe } from "react-icons/fi";
    ...
    <section id="audience" className="py-20 px-4 bg-white">
      ...
      <div className="max-w-4xl mx-auto grid md:grid-cols-3 gap-8">
        <div className="bg-blue-50 rounded-lg p-6 shadow flex flex-col items-center transition-transform hover:scale-105 group">
          <FiBriefcase className="w-12 h-12 mb-4 text-blue-600 group-hover:animate-bounce" />
        ...
        <div className="bg-blue-50 rounded-lg p-6 shadow flex flex-col items-center transition-transform hover:scale-105 group">
          <FiUser className="w-12 h-12 mb-4 text-purple-600 group-hover:animate-spin" />
        ...
        <div className="bg-blue-50 rounded-lg p-6 shadow flex flex-col items-center transition-transform hover:scale-105 group">
          <FiGlobe className="w-12 h-12 mb-4 text-green-600 group-hover:animate-bounce" />
